      ...
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight mt-2">
            Landlord<span className="text-brand-600">Pilot</span> AI
          </h1>
        ...
        <form onSubmit={handleSubmit} className="card p-6 space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="label" htmlFor="units">How many units do you manage?</label>
            <select
              id="units"
              className="input-field"
              value={units}
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white px-2 text-zinc-500">or</span></div>
          </div>
          ...
          <button
            ...
            onClick={() => {
              setName('Demo User');
              setEmail('demo@landlordpilot.ai');
              setPassword('demo123');
              setUnits('5-15');
            }}
          >
          ...
          <p className="text-center text-xs text-zinc-400">No credit card required</p>
        </form>
      </div>
    </div>
  );
